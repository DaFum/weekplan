...
function safeDeepClone(obj) {
  ...
  if (typeof structuredClone === 'function') {
    try {
      ...
      console.warn('safeDeepClone: structuredClone failed', error);
    }
  }
  ...
  try {
    ...
    console.warn('safeDeepClone: JSON clone failed', error);
    return { ...obj };
  }
}
...
export function updateState(newState) {
  ...
  if (
    Object.hasOwn(safeNewState, 'tasks') &&
    !Array.isArray(safeNewState.tasks)
  ) {
    safeNewState.tasks = [];
  }
